package com.cts.grantserve.program_service.aop;

import com.cts.grantserve.program_service.client.AuditLogClient;
...
public class AuditAspect {
    ...
    @Around("execution(* com.cts.grantserve.program_service.controller.*.*(..))")
